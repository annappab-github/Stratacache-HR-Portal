           ...
           <div class="">
            ...
            <div class="row">
              ...
              <form @submit.prevent="submit">
                <div  v-cloak>
                <div class="mb-4 row">
                  <label for="form3Example1cg" class="col-sm-5 col-form-label font-weight-bold">Old Password</label>
                  <div class="col-sm-7">
                    <input type="Password" id="form3Example1cg" class="form-control" placeholder="Old Password" v-model="form.oldPassword" required/>
                ...
                <div class="mb-2 row">
                  ...
                  <div class="col-sm-7">
                    <input type="Password" id="form3Example4cg" class="form-control" placeholder="Confirm Password" v-model="form.confirmPassword" required/>
                   <div class="" style="color: red;" v-if="passwordError">Please provide valid password</div>
                  </div>
                </div>
                 ...
                 <!-- <div class="matches" style="color: red;" v-if='notSamePasswords'>
                  ...
                  <transition name="hint" appear>
                    <div v-show='passwordValidation.error.length > 0 && !submitted' class='hints mt-3'>
                      <div class="pl-2 row">
...
export default {
  ...
  methods: {
    ...
    resetPassword(e){
      ...
      this.loading = true;
      axios.put(this.$hostName + '/passwordChange',{
