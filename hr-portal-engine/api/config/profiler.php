...
return [
    ...
    */
    ...
    'trackers' => [
        \JKocik\Laravel\Profiler\Trackers\ApplicationTracker::class, 
        \JKocik\Laravel\Profiler\Trackers\ContentTracker::class,
...
//        \JKocik\Laravel\Profiler\Trackers\RedisTracker::class, // Redis tab (from Laravel 5.7)
        ...
        \JKocik\Laravel\Profiler\Trackers\PerformanceTracker::class,
