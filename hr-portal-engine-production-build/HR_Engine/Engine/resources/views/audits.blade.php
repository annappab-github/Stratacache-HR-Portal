    ...
    <div class="pdf-body">
                ...
                <table>
                    <tbody>
                        ...
                        <td class="f-bold" style="width: 18%;">Date Range:</td>
                            <td style="width: 27%">{{ $fromDate }} To {{ $toDate }}</td>
                            <td style="width: 10%"></td>
                            <td class="f-bold" style="width: 18%">Generated By:</td>
                            <td style="width: 27%">{{ $generatedBy }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <table class="tableData">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $data->name }}</td>
                    @foreach(explode('Models\\', $data->auditable_type) as $type)
                        @if($loop->last)
                            <td>{{ $type }}</td>
                        @endif
                    @endforeach
